...
public interface db {
    ...
    String naslov1="ODSUSTVO ČLANOVA BO";
    String text1b="Svi članovi biračkog odbora (BO) moraju doći na biračko mjesto (BM) najmanje sat vremena prije početka glasanja (u 06:00h). Prije otvaranja BM, samo članovi BO i akreditovani posmatrači mogu biti prisutni na biračkom mjestu. Predsjednik BO zadužen je izvršiti jasnu raspodjelu zadataka članovima BO. \n\n" +
    ...
    String naslov3="NEDOSTATAK ILI NESTANAK IZBORNOG MATERIJALA";
    String text3= "Birački materijal se u noći prije otvaranja biračkog mjesta čuva u zaključanim prostorijama na lokaciji biračkog mjesta kojeg osigurava policija na lokacijama biračkih mjesta. " +
            "\n\n" +
    ...
    String naslov4="GLASAČKA KUTIJA NIJE POKAZANA PRAZNA I PROPISNO ZAPEČAĆENA";
    String text4="Prije početka glasanja, BO će u prisustvu akreditovanih posmatrača pokazati da je glasačka kutija prazna i potom je propisno zapečatiti na način da praznu glasačku kutiju zatvori, a potom da otvor glasačke kutije osigura odgovarajućim pečatom.";
    String naslov5="TAJNOST GLASANJA";
    String text5="BO osigurava tajnost glasanja na način da je kabina za glasanje postavljena tako da onemogućava druge da imaju uvid u to kako glasač ispunjava glasački listić. To znači da paravani za glasanje moraju biti postavljeni na stolove tako da se nalaze ispred birača koji glasa i onemogućavaju uvid u to za koga birač glasa. Birački odbor određuje mjesto za svaku glasačku kabinu na način da se otvor glasačke kabine okrene prema članovima biračkog odbora i posmatračima, i da bude dovoljno udaljena od članova B.O. , posmatrača ili birača kako bi se omogućila tajnost glasanja.\n";
    String naslov6="!ZABRANA ILI ONEMOGUĆAVANJE POSMATRANJA!";
    String text6="BO ne smije uskratiti posmatranje akreditovanom posmatraču izbora ukoliko je isti akreditovan za posmatranje izbora na biračkom mjestu od strane CIK-a ili OIK-a za osnovnu izbornu jedinicu u kojoj pristupa posmatranju, nalazi se na listi akreditovanih posmatrača, ima važeću akreditaciju i ima važeće bosanskohercegovačke lične dokumente na osnovu kojih je moguće utvrditi identitet posmatrača.\n\n" +
    ...
    String naslov8="PRISUSTVO NEOVLAŠTENIH LICA";
    String text8="Na biračkom mjestu smiju biti prisutni samo članovi biračkog odbora (BO), akreditovani posmatrači i glasači koji trenutno glasaju ili se vrši provjera nijhovog identiteta prije nego pristupe glasanju. Prisustvo i zadržavanje drugih neovlaštenih lica nije dozvoljeno. Toleriše se i kratko prisustvo medija i viših izbornih komisija, ukoliko se ne remeti proces glasanja.";

    String naslov9="MANIPULACIJE PRI IDENTIFIKACIJI BIRAČA I IZDAVANJU GLASAČKIH LISTIĆA";
    String text9="Članovi biračkog odbora svjesno učestvuju u manipulacijama, tako što pojedinim glasačima izdaju više od jednog listića po izbornoj utrci ili dozvoljavaju da jedna osoba glasa više puta u svoje ime u ime drugog birača koji se nije pojavio na biračkom mjestu.";

    String naslov10="GLASANJE BEZ PROPISANOG IDENTIFICIRANJA BIRAČA";
    String text10="Može se dogoditi da članovi BO ne traže bilo kakve dokumente za identifikaciju glasača, ili da prihvataju one koji nisu adekvatni (indeks, ribolovačka dozvola, klupske članske karte, odnosno bilo šta osim važeće bosanskohercegovačke lične karte, pasoša i vozačke dozvole). Ukoliko je učestalost ove pojave velika, to više nije proceduralni propust nego sumnja na manipulaciju.\n" +
            "\n" +
    ...
    String naslov11="KRAĐA ILI IZNOŠENJA GLASAČKIH LISTIĆA VAN BM";
    String text11="Član biračkog odbora zadužen za izdavanje glasačkih listića na prednjoj strani glasačkog listića u donjem lijevom uglu stavlja otisak štembilja pored kojeg se i potpisuje.\n\n" +
    ...
    String naslov12="PRITISCI NA BIRAČE I ZASTRAŠIVANJE";
    String text12="Iako je izborni dan i dan izborne šutnje, događaju se pokušaji nagovaranja, zastrašivanja i pritisaka na birače na samom biračkom mjestu i oko njega, a od strane aktivista pojedinih političkih subjekata.\n" +
            "\n" +
    ...
    String naslov15="FOTOGRAFISANJE GLASAČKIH LISTIĆA";
    String text15="Zabranjeno je fotografisanje glasačkih listića u glasačkoj kabini. To se smatra ozbiljnim kršenjem tajnosti glasanja jer indirektno upućuje na pritisk na glasače ili kupovinu glasova za što se od glasača traži dokumentovanje načina na koji je glasao.";


    String naslov16="KRUŽNO GLASANJE (TZV. BUGARSKI VOZ) – CARUSEL VOTING";
    String text16="Politički subjekti, želeći biti sigurni da će birač glasati za njih, pribavljaju prazan glasački listić, odnosno set listića za sve nivoe koji se biraju. Potom birača šalju na biračko mjesto sa već popunjenim listićima, a on sa biračkog mjesta donosi novi set praznih listića – i tako u krug.\n\n" +
    ...
    String naslov17="ZLOUPOTREBA POMAGAČA PRI GLASANJU";
    String text17b="Glasanje je lično i svako smije glasati samo jednom. Svako smije glasati samo u svoje ime. Jedini izuzetak je pomoć pri glasanju. \n\n" +
    ...
    String naslov21="NESLAGANJA U TESTU TAČNOSTI";
    String text21="Obratite pažnju da se brojevi koje birački odbor utvrđuje i upisuje u odgovrajuće obrasce moraju „slagati“. U tom kontekstu važno je znati da:\n" +
            "-\tBroj zaprimljenih listića za svaki izborni nivo mora biti veći ili jednak od broja\n" +
            "birača upisanih u birački spisak (ne smije biti manji od broja birača upisanih u\n" +
            "birački spisak);\n" +
    ...
    String naslov22="OLOVKE TOKOM BROJANJA GLASOVA";
    String text22="Tokom procesa brojanja glasova na stolu za brojanje dozvoljene su samo olovke crvene boje/tinte.";

    String naslov23="NE POŠTUJE SE REDOSLIJED BROJANJA GLASAČKIH LISTIĆA";
    String text23="Glasački listići se broje tačno definisanim redoslijedom. Na Opštim/Općim izborima 2022. brojanje glasova vrši se po sljedećem redoslijedu:\n" +
            "1. Predsjedništvo BiH\n" +
            "2. Predstavnički dom Parlamentarne skupštine BiH\n" +
            "\n" +
            ...
            "\n" +
            "U Brčko distriktu BiH prvo se broje glasovi po rasporedu brojanja predviđenom za entitet Federacija BiH, a odmah potom za entitet Republika Srpska.\n" +
            "Eventualni prekid rada u brojanju glasačkih listića predsjednik ili zamjenik predsjednika evidentira u zapisnik o radu B.O. u dio Z8.\n";

    String naslov24="PROGLAŠAVANJE NEVAŽEĆIH GLASAČKIH LISTIĆA";
    String text24="Listić je nevažeći ako je na njemu označeno 2 ili više političkih subjekata; ako nije ispunjen (neoznačen) ili je ispunjen tako da nije moguće sa sigurnošću utvrditi kojem kandidatu / političkom subjektu je birač dao svoj glas; ako je glasački listić toliko oštećen da se sa sigurnošću ne može utvrditi kojem kandidatu / političkom subjektu je birač dao glas; ako se na osnovu oznaka koje je birač dopisao na glasački listić, kao što je potpis, može utvrditi njegov identitet; ako su dopisana imena kandidata; ako je skeniran, kopiran, nema otisak štambilja i potpis člana biračkog odbora i / ili je listić koji ne pripada tom biračkom mjestu, odnosno opciji glasanja (glasački listić za glasanje poštom).";

    String naslov25="ZLOUPOTREBA NEISKORIŠTENIH GLASAČKIH LISTIĆA";
    String text25="Prije početka otvaranja glasačkih kutija i brojanja neiskorišteni glasački listići pakuju se u originalne kutije te se zajedno sa oštećenim glasačkim listićima, olovkama (osim onih crvene boje/tinte) i neiskorištenim listićima odlažu u zaštitnu vreću.\n" +
    ...
    String naslov26="NAMJERNA INVALIDACIJA/PONIŠTAVANJE GLASOVA ZA POLITIČKE OPONENTE";
    ...
    String naslov28="ODBIJANJE PREDSJEDNIKA/CE DA UNESE VAŠU PRIMJEDBU";
    String text28="U skladu sa vašim statusom imate pravo na unošenje primjedbi/prigovora u ZARBO. Svako uskraćivanje ovog prava smatra se ozbiljnim kršenjem i o tome trebate hitno izvjestiti centrali ili drugi nadležni organ.\n" +
    ...
    String naslov29="NEPRAVILNO PAKOVANJE IZBORNOG MATERIJALA";
    String text29="Nakon završenog brojanja i pakovanja listića u odgovarajuće vreće, predsjednik BO u manju providnu vreću, na kojoj je obavezno upisana šifra biračkog mjesta, pakuje sljedeći materijal: Zapisnik o radu biračkog odbora – original; izvod iz Centralnog biračkog spiska. Predsjednik i članovi biračkog odbora dužni su potpisati zapisnike i obrasce koje koriste tokom izbornog dana, a čime garantuju za tačnost unesenih podataka. Član BO ima pravo odbiti potpisati se u zapisnike i/ili obrasce.\n";

    String naslov30="PROBLEMI PRILIKOM TRANSPORTA IZBORNOG MATERIJALA";
    String text30="BO odmah, a najkasnije 12 sati nakon zatvaranja biračkog mjesta, dostavlja sav izborni materijal lokalnoj  izbornoj komisiji. Posmatrači imaju pravo pratiti izborni materijal od biračkog mjesta do lokalne izborne komisije";

    String naslov31="!ULAGANJE PRIMJEDBI I PRIGOVORA!";
    String text31b="Izborni zakon BiH u članu 17.9 navodi bitno formalno pravo posmatrača da ulažu primjedbe na rad organa nadležnog za provođenje izbora čiji rad posmatraju. Posmatrač, tako, može stavljati obrazložene primjedbe na rad organa nadležnog za provođenje izbora u pisanoj formi koje se prilažu u zapisnik o radu datog organa. Na osnovu ovako uloženih primjedbi, politički subjekt ima formalno pravo ulaganja prigovora izbornoj komisiji. \n" +
            "\n" +
    ...
    String naslov32="!NE ZABORAVITE - VAŠA SIGURNOST JE NA PRVOM MJESTU!";
    String text32="tekst";


    String naslov33="VRSTE GLASAČKIH LISTIĆA";
    String text33b="Glasački listići u Federaciji BiH i Brčko Distriktu koji su odabrali opciju Federacija:\n" +
            "1. Predsjedništvo BiH - (većinski sistem)\n" +
            "2. Predstavnički dom Parlamentarne skupštine BiH - (sistem\n" +
            "proporcionalne zastupljenosti)\n" +
            "3. Predstavnički dom Parlamenta Federacije BiH - (sistem proporcionalne\n" +
            "zastupljenosti)\n" +
            "4. Skupštine kantona u FBiH - (sistem proporcionalne zastupljenosti)\n\n" +
            "Glasački listići u Republici Srpskoj i Brčko Distriktu koji su odabrali opciju RS:\n" +
            "1. Predsjedništvo BiH - (većinski sistem)\n" +
            "2. Predstavnički dom Parlamentarne skupštine BiH - (sistem\n" +
            "proporcionalne zastupljenosti)\n" +
            "3. Predsjednik i podpredsjednici RS - (većinski sistem)\n" +
            "4. Narodna skupština RS - (sistem proporcionalne zastupljenosti)\n\n" +
            "Članovi Predsjedništva BiH, predsjednik i potpredsjednici RS biraju se po\n" +
            "većinskom sistemu, odnosno sistem proste većine - 'prvi dobija mjesto'.\n" +
            "To znači da je izabran onaj kandidat koji u prvom i jedinom izbornom krugu osvoji\n" +
            "barem jedan glas više od svih ostalih kandidata.\n" +
            "Zastupnici/poslanici u zakonodavna tijela na svim nivoima u BiH se biraju po\n" +
            "sistemu proporcionalne zastupljenosti. Glasači tom prilikom svoj glas mogu dati\n" +
            "jednoj političkoj stranci, listi nezavisnih kandidata, pojedinačnom kandidatu,\n" +
            "\n" +
            "kao i stranci/listi nezavisnih kandidata i jednom ili više kandidata, predstavniku\n" +
            "nacionalnih manjina tamo gdje se biraju, ali samo u okviru te političke stranke/\n" +
            "liste nezavisnih kandidata, odnosno predstavnika nacionalne manjine.";

    String naslov34="ZAPISNICI I OBRASCI NA BM";
    String text34b="Zapisnik o radu biračkog odbora (ZARBO) - Tokom izbornog dana vodi se Zapisnik o radu biračkog odbora. U Zapisnik se unose sljedeći podaci: popis i količina izbornog materijala dostavljena biračkom mjestu; popis svih akreditovanih posmatrača na biračkom mjestu; zapažanja o svim važnim događajima do kojih dođe na biračkom mjestu.\n" +
            "\n" +
    ...
    String naslov35="PRAVA POSMATRAČA";
    String text35b=
            "Pravo na nesmetano posmatranje cjelokupnog procesa\n" +
                    "\n" +
    ...
    String naslov36="PRINCIPI RADA POSMATRAČA";
    String text36b="Svi posmatrači izbornog dana trebaju se pridržavati sljedećih principa rada:\n" +
            "\n" +
            "Nepristrasnost\n" +
            "\n" +
    ...
    String naslov37="ŠTA JE KORISNO IMATI TOKOM POSMATRANJA IZBORA NA BM?";
    String text37="-\tVažeći ident. dokument\n" +
            "-\tAkreditaciju\n" +
            "-\tPriručnik\n" +
            "-\tObrasce\n" +
            "-\tHemijsku olovku\n" +
    ...
    String naslov38="KORIŠTENE SKRAĆENICE";
    String text38="BM – Biračko mjesto\n" +
            "BO – Birački odbor\n" +
    ...
    String text1A="Svi clanovi birackog odbora (BO) moraju doci na biracko mjesto (BM) najmanje sat vremena prije pocetka glasanja (u 06:00h). Prije otvaranja BM, samo clanovi BO i akreditovani posmatraci mogu biti prisutni na birackom mjestu. Predsjednik BO zaduzen je izvrsiti jasnu raspodjelu zadataka clanovima BO. clanovi B.O. na vidnom mjestu objavljuju spisak clanova birackog odbora sa naznakom politickog subjekta koji ih je nominirao.clanovi B.O. na vidnom mjestu objavljuju spisak clanova birackog odbora sa naznakom politickog subjekta koji ih je nominirao. \n\n" +
    ...
    String text3A="Biracki materijal se u noci prije otvaranja birackog mjesta cuva u zakljucanim prostorijama na lokaciji birackog mjesta kojeg osigurava policija na lokacijama birackih mjesta. Prije pocetka glasanja, BO ce u prisustvu akreditovanih posmatraca:\n\n" +
    ...
    String text4A="Prije pocetka glasanja, BO ce u prisustvu akreditovanih posmatraca pokazati da je glasacka kutija prazna i potom je propisno zapecatiti na nacin da praznu glasacku kutiju zatvori, a potom da otvor glasacke kutije osigura odgovarajucim pecatom.";
    String text5A="BO osigurava tajnost glasanja na nacin da je kabina za glasanje postavljena tako da onemogucava druge da imaju uvid u to kako glasac ispunjava glasacki listic. To znaci da paravani za glasanje moraju biti postavljeni na stolove tako da se nalaze ispred biraca koji glasa i onemogucavaju uvid u to za koga birac glasa. Biracki odbor odredjuje odreduje mjesto za svaku glasacku kabinu na nacin da se otvor glasacke kabine okrene prema clanovima birackog odbora i posmatracima, i da bude dovoljno udaljena od clanova B.O. , posmatraca ili biraca kako bi se omogucila tajnost glasanja.\n";
    String text6A="BO ne smije uskratiti posmatranje akreditovanom posmatracu izbora ukoliko je isti akreditovan za posmatranje izbora na birackom mjestu od strane CIK-a ili OIK-a za osnovnu izbornu jedinicu u kojoj pristupa posmatranju, nalazi se na listi akreditovanih posmatraca, ima vazecu akreditaciju i ima vazece bosanskohercegovacke licne dokumente na osnovu kojih je moguce utvrditi identitet posmatraca.\n" +
    ...
    String text8A="Na birackom mjestu smiju biti prisutni samo clanova irackog odbora (BO), akreditovani posmatraci i glasaci koji trenutno glasanju ili se vrsi provjera nijhovog identiteta prije nego pristupe glasanju. Prisustvo i zadrzavanje drugih neovlastenih lica nije dozvoljenom. Tolerise se i kratko prisustvo medija i visih izbornih komisija, ukoliko se ne remeti proces glasanja.";

    String text9A="Članovi birackog odbora svjesno ucestvuju u manipulacijama, tako sto pojedinim glasacima izdaju vise od jednog listica po izbornoj utrci ili dozvoljavaju da jedna osoba glasa vise puta u svoje ime ili u ime drugog biraca koji se nije pojavio na birackom mjestu.";

    String text10A="Moze se dogoditi da zlanovi BO ne traze bilo kakve dokumente za identifikaciju glasaca, ili da prihvataju one koji nisu adekvatni (indeks, ribolovazka dozvola, klupske zlanske karte, odnosno bilo sta osim vazece bosanskohercegovacke licne karte, pasosa i vozacke dozvole). Ukoliko je uzestalost ove pojave velika, to vise nije proceduralni propust nego sumnja na manipulaciju.\n" +
            "\n" +
    ...
    String text11A="clan birackog odbora zaduzen za izdavanje glasackih listica na prednjoj strani glasackog listica u donjem lijevom uglu stavlja otisak stembilja pored kojeg se i potpisuje.\n" +
    ...
    String text12A="Iako je izborni dan i dan izborne sutnje, dogadaju se pokusaji nagovaranja, zastrasivanja i pritisaka na birace na samom birackom mjestu i oko njega, a od strane aktivista pojedinih politickih subjekata.\n" +
            "\n" +
    ...
    String text15A="Zabranjeno je fotografisanje glasackih listica u glasackoj kabini. To se smatra ozbiljnim krsenjem tajnosti glasanja jer indirektno upucuje na pritisk na glasace ili kupovinu glasova za sto se od glasaca trazi dokumentovanje nacina na koji je glasao.";


    String text16A="Politicki subjekti, zeleci biti sigurni da će birac glasati za njih, pribavljaju prazan glasacki listic, odnosno set listica za sve nivoe koji se biraju. Potom biraca salju na biracko mjesto sa vec popunjenim listicima, a on sa birackog mjesta donosi novi set praznih listica – i tako u krug.\n" +
    ...
    String text17A="Glasanje je licno i svako smije glasati samo jednom. Svako smije glasati samo u svoje ime. Jedini izuzetak je pomoc pri glasanju. \n" +
    ...
    String text18A="Svako nasilje na birackom mjestu je predstavlja ozbiljno krsenje izbornih procedura. Vazno je misliti na vlastitu sigurnost, udaljiti se sa birackog mjesta i pozvati nadlezne organe bezbjednosti.";


    String text19A="Biracka mjesta se po pravilu zatvaraju u 19:00h. U slucaju kasnjenja u otvaranju, velike guzve i / ili duzeg prekida glasanja na birackom mjestu, biracki odbor moze produziti proces glasanja. Oni biraci koji se zateknu u redu za glasanje u 19:00h mogu glasati. Procedura zatvaranja je sljedeca: predsjednik BO objavljuje 15 minuta prije zatvaranja BM svim prisutnim u i ispred BM vrijeme zatvaranja. Član BO zaduzen za kontrolu reda u vrijeme zatvaranja BM staje na kraj reda kako bi se osiguralo da se nijedna osoba ne prikljuci nakon 19:00h. Nakon sto posljednji birac iz reda glasa, zatvaraju se vrata BM. Predsjednik u Zapisnik unosi vrijeme zatvaranja birackog mjesta, a nakon cega zatvara otvor glasacke kutije samoljepljivom trakom i potpisuje je. Prilikom zatvaranja birackog mjesta predsjednik u Zapisnik evidentira prisutne posmatrace.\n" +
    ...
    String text21A="Obratite paznju da se brojevi koje biracki odbor utvrduje i upisuje u odgovrajuce obrasce moraju „slagati“. U tom kontekstu vazno je znati da:\n" +
    ...
    String text22A="Tokom procesa brojanja glasavo na stolu za brojanje dozvoljene su samo olovke crvene boje/tinte.";

    String text23A="Glasacki listici se broje tacno definisanim redoslijedom. Na Opstim/Opcim izborima 2022. brojanje glasova vrsi se po sljedecem redoslijedu:\n" +
            "1. Predsjednistvo BiH\n" +
            "2. Predstavnicki dom Parlamentarne skupstine BiH\n" +
            "\n" +
            "Zatim se u Republici Srpskoj pristupa brojanju glasova za:\n" +
    ...
    String text28A="U skladu sa vasim statusom imate pravo na unosenje primjedbi/prigovora u ZARBO. Svako uskracivanje ovog prava smatra se ozbiljnim krsenjem i o tome trebate hitno izvjestiti centrali uli drugi nadlezni organ.\n" +
    ...
    String text32A="tekst";


    String text33A="Nacelnici/Gradonacelnici biraju se po vecinskom sistemu, odnosno sistem proste vecine - \"prvi dobija mjesto\". To znaci da je izabran onaj kandidat koji u prvom i jedinom izbornom krugu osvoji barem jedan glas vise od svih ostalih kandidata. \n" +
            "\n" +
    ...
    String text35A="Pravo na nesmetano posmatranje cjelokupnog procesa\n" +
            "\n" +
            "B.O. mora omoguciti akreditiranim posmatracima nesmetano promatranje cijelog procesa glasanja i prebrojavanja glasackih listica i upisa primjedbi u Zapisnik o radu birackog odbora.\n" +
            "Pristup dokumentima\n" +
            "\n" +
            "Posmatraci moraju imati pristup svim dokumentima koji se na dan izbora nalaze na birackom mjestu (izvod iz Centralnog birackog spisa, obrasci, zapisnici, itd.). Naravno, ovo podrazumijeva ljubazno ponasanje, pristojnu komunikaciju sa ovlastenima, te pravi izbor vremena da se neki zahtjev ovog tipa i postavi. Procijenite je li pravo vrijeme traziti da pogledate neki dokument u trenutku kada je nadlezna osoba izuzetno zauzeta redovnim aktivnostima na birackom mjestu ili u izbornoj komisiji!\n" +
            "\n" +
            "\n" +
            "Stavljanje primjedbi u Zapisnik o radu birackog odbora (ZARBO)\n" +
            "\n" +
            "Bitno formalno pravo posmatraca izbornog dana je i stavljanje obrazlozenih primjedbi na rad birackog odbora i opstinske izborne komisije. Vazno je naglasiti da samo ono sto ude u ZARBO moze biti iskoristeno za ulaganje formalnog prigovora. Ono sto nije uneseno u Zapisnik, kao da se nije ni dogodilo! Prilikom ulaganja primjedbe, gdje god je to moguce, vazno je kvantificirati - navesti na koji nacin i sa koliko glasova je nepravilnost navedena primjerom uticala na rezultat izbora.\n" +
            "Posmatrac ima pravo zahtijevati prepis zapisnika o radu organa nadleznog za provedbu izbora ciji rad je posmatrao .\n" +
            "\n" +
            "\n" +
            "Kopija rezultata glasanja sa birackog mjesta\n" +
            "\n" +
            "Pravo posmatraca je i dobiti sluzbene rezultate glasanja. Obrazac koji sluzi za tu namjenu (ZR) nema dovoljno kopija da bi svaki posmatrac mogao dobiti primjerak. Alternativno mozete fotografisati javno istaknutu zutu kopiju ili napraviti prepis u formulare koji ce biti dostavljeni uz biracki materijal i ljubazno zamoliti predsjednika BO da se potpise na prepis.\n";

    String text36A="Svi posmatraci izbornog dana trebaju se pridrzavati sljedecih principa rada:\n" +
            "\n" +
            "Nepristrasnost\n" +
            "\n" +
            ...
            "Ne dirajte izborni materijal\n" +
            "\n" +
            "Posmatrac ima pravo uvida u cjelokupni izborni materijal na birackom mjestu. Iako cete vjerovatno biti u prilici, nemojte dirati bilo kakav izborni materijal. Ovo se posebno odnosi na glasacke listice. Kada smatrate da je potrebno pregledati odredeni odredjeni materijal, ljubazno zamolite predsjednika birackog odbora da vam ga pokaze.\n";

    String text37A="-\tVazeci ident. dokument\n" +
            "-\tAkreditaciju\n" +
            "-\tPrirucnik\n" +
            "-\tObrasce\n" +
            "-\tHemijsku olovku\n" +
            "-\tNapunjen mob. telefon\n" +
            "-\tPunjac za mob. telefon\n" +
            "-\tHranu i pice\n" +
            "-\tToplu odjecu i obucu\n" +
            "-\tBaterijsku lampu (po potrebi)\n" +
            "-\tKisobran (po potrebi)\n";

    String text38A="BM – Biracko mjesto\\n\" +\n" +
            "            \"BO – Biracki odbor\\n\" +\n" +
            "            \"CIK BiH – Centralna izborna komisija Bosne i Hercegovine\\n\" +\n" +
    ...
    String texto1 ="Najvažnija je vaša sigurnost! U slučaju da ste procjenili da je vaša sigurnost ugrožena poduzmite sve mjere kako bi se zaštitili, a nakon toga obavjestite nadležne institucije.";
    String texto2 ="Ukoliko se dešava nasilje na BM ili je ugoržana vaša sigurnost ili sigurnost drugih učesnika izbornog procesa o tome odmah  obavjestite policiju. Broj policije je 122. ";
    String texto3="U skladu sa organizacijskom strukturom i/ili internim procedurama posmatračke misije, izvjestite nadležnu osobu o uočenim izbornim nepravilnostima ili propustima u radu BO.";
    String texto4="Ukoliko se dešava sistemsko kršenje izbornog procesa, veće nepravilnosti ili se propusti ponavljaju uprkos vašem upozorenju unesite primjedbu u Zapisnik o radu BO u skladu sa procedurom. Na kraju izbornog dana tražirte prepis zapisnika o radu BO. Samo na osnovu vaše evidentirane primjedbe moguće je pokretati dalje procese u cilju zaštite izbornih prava.";
    String texto5="Za svaku izbornu neprvilnost ili učestale propuste poželjno je imati dokaze kojima se ista potkrepljuje. Pokušajte prikupiti što više informacija i dokaza (prekršioce ili učesnike događaja, detaljan opis nepravilnosti, kopije obrazaca, fotografije, video i sl.) pri tome vodite računa da se pridržavate zakona i procedura i ne ugrozite vlastitu sigurnost.";
    String texto6="Skrenite pažnju predsjedniku Biračkog odobra na uočenu izbornu nepravilnost ili propust u radu članova BO. Odaberite pogodan trenutak, kada predsjednik BO nije zauzet drugim važnijim aktivnostima kako ne bi remetili proces glasanja.";
    String texto7="Ukoliko su vam uskraćena prava posmatrača ili se ne poduzimaju koraci u cilju otklanjanja nepravlnosti, uprkos vašim upozorenjima, o tome možete obavjestiti nadležnu loklanu izbornu komisiju, u skladu sa organizacijskom strukturuom i/ili internim procedurama posmatračke misije.";
    String texto8="Akreditovani posmatrač može zahtjevati da CIK BiH ponovo broji glasačke listiće na BM na kojem je bio posmatrač u skladu sa procedurom. Zahtjev za ponovno brojanje glasačkih listića podnosi se u pisanoj formi CIK-u BiH u roku od tri dana od objave izbornih rezultata. Ponovno brojanje se obavlja u glavnom centru za brojanje glasova a akreditovani posmatrači mogu biti pristni u toku ponovnog brojanja glasova.";
    String texto9="Pravo posmatrača je i dobiti službene rezultate glasanja. Obrazac koji služi za tu namjenu (ZR) nema dovoljno kopija da bi svaki posmatrač mogao dobiti primjerak. Alternativno možete fotografisati javno istaknutu žutu kopiju ili napraviti prepis u formulare koji će biti dostavljeni uz birački materijal i ljubazno zamoliti predsjednika BO da se potpiše na prepis.";

    String texto1a ="Najvaznija je vaca sigurnost! U slucaju da ste procjenili da je vaca sigurnost ugrozena poduzmite sve mjere kako bi se zactitili, a nakon toga obavjestite nadlezne institucije.";
    String texto2a ="Ukoliko se decava nasilje na BM ili ugorzana vaca sigurnost ili sigurnost drugih ucesnika izbornog procesa o tome odmah  obavjestite policiju. Broj policije je 122. ";
    String texto3a="U skladu sa organizacijskom strukturuom i/ili internim procedurama posmatracke misije, izvjestite nadleznu osobu o uocenim izbornim nepravilnostima ili propustima u radu BO.";
    String texto4a="Ukoliko se decava sistemsko krsenje izbornog procesa, vece nepravilnosti ili se proposti ponavljaju uprkos vacem upozorenju unesite primjedbu u Zapisnik o radu BO u skladu sa procedurom. Na kraju izbornog dana trazirte prepis zapisnika o radu BO. Samo na osnovu vace evidentirane primjedbe moguce je pokretati dalje procese u cilju zactite izbornih prava.";
    String texto5a="Za svaku izbornu neprvilnost ili ucestale propuste pozeljno je imati dokaze kojima se ista potkrepljuje. Pokucajte prikupiti cto vice informacija I dokaza (prekrcioce ili ucesnike dogadaja, detaljan opis nepravilnosti, kopije obrazaca, fotografije, video i sl.) pri tome vodite racuna da se pridrzavate zakona i procedura i ne ugrozite vlastitu sigurnost.";
    String texto6a="Skrenite paznju predsjedniku Birackog odobra na uocenu izbornu nepravilnost ili propust u radu clanova BO. Odaberite pogodan trenutak, kada predsjednik BO nije zauzet drugim vaznijim aktivnostima kako ne bi remetili proces glasanja.\n";
    String texto7a="Ukoliko su vam uskracena prava posmatraca ili se ne poduzimaju koraci u cilju otklanjanja nepravlnosti, uprkos vacim upozorenjima, o tome mozete obavjestiti nadleznu loklanu izbornu komisiju, a skladu sa organizacijskom strukturuom i/ili internim procedurama posmatracke misije.";
    String texto8a="Akreditovani posmatrac moze zahtjevati da CIK BiH ponovo broji glasacke listice na BM na kojem je bio posmatrac u skladu sa procedurom. Zahtjev za ponovno brojanje glasackih listica podnosi se u pisanoj formi CIK-u BiH u roku od tri dana od objave izbornih rezultata. Ponovno brojanje se obavlja u glavnom centru za brojanje glasova a akreditovani posmatraci mogu biti pristni u toku ponovnog brojanja glasova.";
    String texto9a="Pravo posmatraca je i dobiti sluzbene rezultate glasanja. Obrazac koji sluzi za tu namjenu (ZR) nema dovoljno kopija da bi svaki posmatrac mogao dobiti primjerak. Alternativno mozete fotografisati javno istaknutu zutu kopiju ili napraviti prepis u formulare koji ce biti dostavljeni uz biracki materijal i ljubazno zamoliti predsjednika BO da se potpice na prepis.";

    String texto01 = texto1+texto1a;
    String texto02 = texto2+texto2a;
    String texto03 = texto3+texto3a;
    String texto04 = texto4+texto4a;
    String texto05 = texto5+texto5a;
    String texto06 = texto6+texto6a;
    String texto07 = texto6+texto7a;
    String texto08 = texto8+texto8a;
    String texto09 = texto9+texto9a;

    String m1a="Fizičko nasilje na BM / Ugrožena sigurnost\n" +
            "Zaštite se\n" +
            "Pozovite policiju \n" +
            "Prijavite nepravilnost i/ili kontaktirajte nadležnog koordinatora za posmatranje izbora\n" +
            "Unesite primjedbu u Zapisnik o radu BO"+
            "Dokumentujte nepravilnost/kršenje ";
    String m2a="Zabrana posmatranja ili uskraćivanje prava posmatrača\n" +
            "Upozorite predsjednika BO \n" +
            "Prijavite nepravilnost i/ili kontaktirajte nadležnog koordinatora za posmatranje izbora\n" +
            "Kontaktirajte Opštinsku/Gradsku izbornu komisiju";
    String m3a ="Bugarski voz (Kružno glasanju)\n" +
            "Upozorite predsjednika BO \n" +
            "Prijavite nepravilnost i/ili kontaktirajte nadležnog koordinatora za posmatranje izbora\n" +
            "Unesite primjedbu u Zapisnik o radu BO\n" +
            "Kontaktirajte Opštinsku/Gradsku izbornu komisiju\n" +
            "Dokumentujte nepravilnost/kršenje\n";
    String m4a="Kupovina glasova\n" +
            "Prijavite nepravilnost i/ili kontaktirajte nadležnog koordinatora za posmatranje izbora\n" +
            "Kontaktirajte Opštinsku/Gradsku izbornu komisiju\n" +
            "Dokumentujte nepravilnost/kršenje\n" +
            "Pozovite policiju\n";
    String m5a="Pritisci na birače i zastrašivanje\n" +
            "Upozorite predsjednika BO \n" +
            "Prijavite nepravilnost i/ili kontaktirajte nadležnog koordinatora za posmatranje izbora\n" +
            "Kontaktirajte Opštinsku/Gradsku izbornu komisiju\n" +
            "Dokumentujte nepravilnost/kršenje\n" +
            "Pozovite policiju\n";
    String m6a="Kršenje izborne šutnje\n" +
            "Upozorite predsjednika BO \n" +
            "Prijavite nepravilnost i/ili kontaktirajte nadležnog koordinatora za posmatranje izbora\n" +
            "Unesite primjedbu u Zapisnik o radu BO\n" +
            "Kontaktirajte Opštinsku/Gradsku izbornu komisiju\n" +
            "Dokumentujte nepravilnost/kršenje";
    String m7a="Porodično glasanju\n" +
            "Upozorite predsjednika BO \n" +
            "Prijavite nepravilnost i/ili kontaktirajte nadležnog koordinatora za posmatranje izbora\n" +
            "Unesite primjedbu u Zapisnik o radu BO\n" +
            "Kontaktirajte Opštinsku/Gradsku izbornu komisiju\n" +
            "Dokumentujte nepravilnost/kršenje\n";
    String m8a="Zloupotreba pomoci pri glasanju\n" +
            "Upozorite predsjednika BO \n" +
            "Prijavite nepravilnost i/ili kontaktirajte nadležnog koordinatora za posmatranje izbora\n" +
            "Unesite primjedbu u Zapisnik o radu BO\n" +
            "Kontaktirajte Opštinsku/Gradsku izbornu komisiju\n" +
            "Dokumentujte nepravilnost/kršenje\n";
    String m9a ="\n" +
            "Nisu istaknuti rezultati izbora (žute kopije)\n" +
            "Upozorite predsjednika BO \n" +
            "Tražite kopiju rezultata glasanja (žutu kopiju)\n" +
            "Prijavite nepravilnost i/ili kontaktirajte nadležnog koordinatora za posmatranje izbora\n" +
            "Unesite primjedbu u Zapisnik o radu BO\n" +
            "Kontaktirajte Opštinsku/Gradsku izbornu komisiju\n" +
            "Dokumentujte nepravilnost/kršenje\n";
    String m10a="Kašnjenje u otvaranju BM preko 3 sata\n" +
            "Upozorite predsjednika BO \n" +
            "Prijavite nepravilnost i/ili kontaktirajte nadležnog koordinatora za posmatranje izbora\n" +
            "Unesite primjedbu u Zapisnik o radu BO\n" +
            "Kontaktirajte Opštinsku/Gradsku izbornu komisiju\n" +
            "Dokumentujte nepravilnost/kršenje\n";
    String m11a ="Odsustvo članova BO\n" +
            "Upozorite predsjednika BO \n" +
            "Prijavite nepravilnost i/ili kontaktirajte nadležnog koordinatora za posmatranje izbora\n" +
            "Unesite primjedbu u Zapisnik o radu BO\n" +
            "Kontaktirajte Opštinsku/Gradsku izbornu komisiju\n" +
            "Dokumentujte nepravilnost/kršenje\n";
    String m12a="Nedostatak ili nestanak izbornog materijala\n" +
            "Prijavite nepravilnost i/ili kontaktirajte nadležnog koordinatora za posmatranje izbora\n" +
            "Unesite primjedbu u Zapisnik o radu BO\n" +
            "Kontaktirajte Opštinsku/Gradsku izbornu komisiju\n" +
            "Dokumentujte nepravilnost/kršenje";
    String m13a="Narušena tajnost glasanju\n" +
            "Upozorite predsjednika BO \n" +
            "Prijavite nepravilnost i/ili kontaktirajte nadležnog koordinatora za posmatranje izbora\n" +
            "Unesite primjedbu u Zapisnik o radu BO\n" +
            "Kontaktirajte Opštinsku/Gradsku izbornu komisiju\n" +
            "Dokumentujte nepravilnost/kršenje\n";
    String m14a="Manipulacije pri identifikaciji birača\n" +
            "Upozorite predsjednika BO \n" +
            "Prijavite nepravilnost i/ili kontaktirajte nadležnog koordinatora za posmatranje izbora\n" +
            "Unesite primjedbu u Zapisnik o radu BO\n" +
            "Kontaktirajte Opštinsku/Gradsku izbornu komisiju\n" +
            "Dokumentujte nepravilnost/kršenje\n";
    String m15a="Manipulacije pri izdavanju glasačkih listića\n" +
            "Upozorite predsjednika BO \n" +
            "Prijavite nepravilnost i/ili kontaktirajte nadležnog koordinatora za posmatranje izbora\n" +
            "Unesite primjedbu u Zapisnik o radu BO\n" +
            "Kontaktirajte Opštinsku/Gradsku izbornu komisiju\n" +
            "Dokumentujte nepravilnost/kršenje\n";
    String m16a="Uskraćivanje prava na glasanje\n" +
            "Upozorite predsjednika BO \n" +
            "Prijavite nepravilnost i/ili kontaktirajte nadležnog koordinatora za posmatranje izbora\n" +
            "Unesite primjedbu u Zapisnik o radu BO\n" +
            "Kontaktirajte Opštinsku/Gradsku izbornu komisiju\n" +
            "Dokumentujte nepravilnost/kršenje\n";
    String m17a="Neslaganja u testu tačnosti \n" +
            "Upozorite predsjednika BO \n" +
            "Prijavite nepravilnost i/ili kontaktirajte nadležnog koordinatora za posmatranje izbora\n" +
            "Unesite primjedbu u Zapisnik o radu BO\n" +
            "Dokumentujte nepravilnost/kršenje\n" +
            "Tražite kopiju rezultata glasanja (žutu kopiju)\n" +
            "Zatražite od CIK-a BiH ponovno brojanje glasova";
    String m18a="Zloupotrebe glasačkih listića pri brojanju\n" +
            "Upozorite predsjednika BO \n" +
            "Prijavite nepravilnost i/ili kontaktirajte nadležnog koordinatora za posmatranje izbora\n" +
            "Unesite primjedbu u Zapisnik o radu BO\n" +
            "Dokumentujte nepravilnost/kršenje\n" +
            ...
            "Pozovite policiju\n" +
            "Zatražite od CIK-a BiH ponovno brojanje glasova\n";
    String m19a="Namjerno poništavanje glasova\n" +
            "Upozorite predsjednika BO \n" +
            "Prijavite nepravilnost i/ili kontaktirajte nadležnog koordinatora za posmatranje izbora\n" +
            "Unesite primjedbu u Zapisnik o radu BO\n" +
            "Dokumentujte nepravilnost/kršenje\n" +
            ...
            "Pozovite policiju\n" +
            "Zatražite od CIK-a BiH ponovno brojanje glasova\n";
    String m20a="Nedozvoljeno dopisivanje glasova\n" +
            "Upozorite predsjednika BO \n" +
            "Prijavite nepravilnost i/ili kontaktirajte nadležnog koordinatora za posmatranje izbora\n" +
            "Unesite primjedbu u Zapisnik o radu BO\n" +
            "Dokumentujte nepravilnost/kršenje\n" +
            ...
            "Pozovite policiju\n" +
            "Zatražite od CIK-a BiH ponovno brojanje glasova\n";
    String m21a="Pogrešno evidentiranje rezultata glasanju na BM\n" +
            "Upozorite predsjednika BO \n" +
            "Prijavite nepravilnost i/ili kontaktirajte nadležnog koordinatora za posmatranje izbora\n" +
            "Unesite primjedbu u Zapisnik o radu BO\n" +
            "Dokumentujte nepravilnost/kršenje\n" +
            ...
            "Kontaktirajte Opštinsku/Gradsku izbornu komisiju\n" +
            "Zatražite od CIK-a BiH ponovno brojanje glasova\n";
    String m22a="Otvaranje vreća sa izbornim materijlaom tokom transporta\n" +
            "Upozorite predsjednika BO \n" +
            "Prijavite nepravilnost i/ili kontaktirajte nadležnog koordinatora za posmatranje izbora\n" +
            "Unesite primjedbu u Zapisnik o radu BO\n" +
            "Dokumentujte nepravilnost/kršenje\n" +
            ...
            "Zatražite od CIK-a BiH ponovno brojanje glasova\n" +
            "\n";
    String m1b="Fizicko nasilje na BM / Ugrozena sigurnost\n" +
            "Zastite se\n" +
            "Pozovite policiju \n" +
            "Prijavite nepravilnost i/ili kontaktirajte nadleznog koordinatora za posmatranje izbora\n" +
            "Unesite primjedbu u Zapisnik o radu BO"+
            "Dokumentujte nepravilnost/krsenje ";
    String m2b="Zabrana posmatranja ili uskracivanje prava posmatraca\n" +
            "Upozorite predsjednika BO \n" +
            "Prijavite nepravilnost i/ili kontaktirajte nadleznog koordinatora za posmatranje izbora\n" +
            "Kontaktirajte Opstinsku/Gradsku izbornu komisiju";
    String m3b ="Bugarski voz (Kruzno glasanju)\n" +
            "Upozorite predsjednika BO \n" +
            "Prijavite nepravilnost i/ili kontaktirajte nadleznog koordinatora za posmatranje izbora\n" +
            "Unesite primjedbu u Zapisnik o radu BO\n" +
            "Kontaktirajte Opstinsku/Gradsku izbornu komisiju\n" +
            "Dokumentujte nepravilnost/krsenje\n";
    String m4b="Kupovina glasova\n" +
            "Prijavite nepravilnost i/ili kontaktirajte nadleznog koordinatora za posmatranje izbora\n" +
            "Kontaktirajte Opstinsku/Gradsku izbornu komisiju\n" +
            "Dokumentujte nepravilnost/krsenje\n" +
            "Pozovite policiju\n";
    String m5b="Pritisci na birace i zastrasivanje\n" +
            "Upozorite predsjednika BO \n" +
            "Prijavite nepravilnost i/ili kontaktirajte nadleznog koordinatora za posmatranje izbora\n" +
            "Kontaktirajte Opstinsku/Gradsku izbornu komisiju\n" +
            "Dokumentujte nepravilnost/krsenje\n" +
            "Pozovite policiju\n";
    String m6b="Krsenje izborne sutnje\n" +
            "Upozorite predsjednika BO \n" +
            "Prijavite nepravilnost i/ili kontaktirajte nadleznog koordinatora za posmatranje izbora\n" +
            "Unesite primjedbu u Zapisnik o radu BO\n" +
            "Kontaktirajte Opstinsku/Gradsku izbornu komisiju\n" +
            "Dokumentujte nepravilnost/krsenje";
    String m7b="Porodicno glasanju\n" +
            "Upozorite predsjednika BO \n" +
            "Prijavite nepravilnost i/ili kontaktirajte nadleznog koordinatora za posmatranje izbora\n" +
            "Unesite primjedbu u Zapisnik o radu BO\n" +
            "Kontaktirajte Opstinsku/Gradsku izbornu komisiju\n" +
            "Dokumentujte nepravilnost/krsenje\n";
    String m8b="Zloupotreba pomoci pri glasanju\n" +
            "Upozorite predsjednika BO \n" +
            "Prijavite nepravilnost i/ili kontaktirajte nadleznog koordinatora za posmatranje izbora\n" +
            "Unesite primjedbu u Zapisnik o radu BO\n" +
            "Kontaktirajte Opstinsku/Gradsku izbornu komisiju\n" +
            "Dokumentujte nepravilnost/krsenje\n";
    String m9b ="\n" +
            "Nisu istaknuti rezultati izbora (zute kopije)\n" +
            "Upozorite predsjednika BO \n" +
            "Trazite kopiju rezultata glasanja (zutu kopiju)\n" +
            "Prijavite nepravilnost i/ili kontaktirajte nadleznog koordinatora za posmatranje izbora\n" +
            "Unesite primjedbu u Zapisnik o radu BO\n" +
            "Kontaktirajte Opstinsku/Gradsku izbornu komisiju\n" +
            "Dokumentujte nepravilnost/krsenje\n";
    String m10b="Kasnjenje u otvaranju BM preko 3 sata\n" +
            "Upozorite predsjednika BO \n" +
            "Prijavite nepravilnost i/ili kontaktirajte nadleznog koordinatora za posmatranje izbora\n" +
            "Unesite primjedbu u Zapisnik o radu BO\n" +
            "Kontaktirajte Opstinsku/Gradsku izbornu komisiju\n" +
            "Dokumentujte nepravilnost/krsenje\n";
    String m11b ="Odsustvo clanova BO\n" +
            "Upozorite predsjednika BO \n" +
            "Prijavite nepravilnost i/ili kontaktirajte nadleznog koordinatora za posmatranje izbora\n" +
            "Unesite primjedbu u Zapisnik o radu BO\n" +
            "Kontaktirajte Opstinsku/Gradsku izbornu komisiju\n" +
            "Dokumentujte nepravilnost/krsenje\n";
    String m12b="Nedostatak ili nestanak izbornog materijala\n" +
            "Prijavite nepravilnost i/ili kontaktirajte nadleznog koordinatora za posmatranje izbora\n" +
            "Unesite primjedbu u Zapisnik o radu BO\n" +
            "Kontaktirajte Opstinsku/Gradsku izbornu komisiju\n" +
            "Dokumentujte nepravilnost/krsenje";
    String m13b="Narusena tajnost glasanju\n" +
            "Upozorite predsjednika BO \n" +
            "Prijavite nepravilnost i/ili kontaktirajte nadleznog koordinatora za posmatranje izbora\n" +
            "Unesite primjedbu u Zapisnik o radu BO\n" +
            "Kontaktirajte Opstinsku/Gradsku izbornu komisiju\n" +
            "Dokumentujte nepravilnost/krsenje\n";
    String m14b="Manipulacije pri identifikaciji biraca\n" +
            "Upozorite predsjednika BO \n" +
            "Prijavite nepravilnost i/ili kontaktirajte nadleznog koordinatora za posmatranje izbora\n" +
            "Unesite primjedbu u Zapisnik o radu BO\n" +
            "Kontaktirajte Opstinsku/Gradsku izbornu komisiju\n" +
            "Dokumentujte nepravilnost/krsenje\n";
    String m15b="Manipulacije pri izdavanju glasackih listica\n" +
            "Upozorite predsjednika BO \n" +
            "Prijavite nepravilnost i/ili kontaktirajte nadleznog koordinatora za posmatranje izbora\n" +
            "Unesite primjedbu u Zapisnik o radu BO\n" +
            "Kontaktirajte Opstinsku/Gradsku izbornu komisiju\n" +
            "Dokumentujte nepravilnost/krsenje\n";
    String m16b="Uskracivanje prava na glasanje\n" +
            "Upozorite predsjednika BO \n" +
            "Prijavite nepravilnost i/ili kontaktirajte nadleznog koordinatora za posmatranje izbora\n" +
            "Unesite primjedbu u Zapisnik o radu BO\n" +
            "Kontaktirajte Opstinsku/Gradsku izbornu komisiju\n" +
            "Dokumentujte nepravilnost/krsenje\n";
    String m17b="Neslaganja u testu tacnosti \n" +
            "Upozorite predsjednika BO \n" +
            "Prijavite nepravilnost i/ili kontaktirajte nadleznog koordinatora za posmatranje izbora\n" +
            "Unesite primjedbu u Zapisnik o radu BO\n" +
            "Dokumentujte nepravilnost/krsenje\n" +
            "Trazite kopiju rezultata glasanja (zutu kopiju)\n" +
            "Zatrazite od CIK-a BiH ponovno brojanje glasova";
    String m18b="Zloupotrebe glasackih listica pri brojanju\n" +
            "Upozorite predsjednika BO \n" +
            "Prijavite nepravilnost i/ili kontaktirajte nadleznog koordinatora za posmatranje izbora\n" +
            "Unesite primjedbu u Zapisnik o radu BO\n" +
            "Dokumentujte nepravilnost/krsenje\n" +
            ...
            "Pozovite policiju\n" +
            "Zatrazite od CIK-a BiH ponovno brojanje glasova\n";
    String m19b="Namjerno ponistavanje glasova\n" +
            "Upozorite predsjednika BO \n" +
            "Prijavite nepravilnost i/ili kontaktirajte nadleznog koordinatora za posmatranje izbora\n" +
            "Unesite primjedbu u Zapisnik o radu BO\n" +
            "Dokumentujte nepravilnost/krsenje\n" +
            ...
            "Pozovite policiju\n" +
            "Zatrazite od CIK-a BiH ponovno brojanje glasova\n";
    String m20b="Nedozvoljeno dopisivanje glasova\n" +
            "Upozorite predsjednika BO \n" +
            "Prijavite nepravilnost i/ili kontaktirajte nadleznog koordinatora za posmatranje izbora\n" +
            "Unesite primjedbu u Zapisnik o radu BO\n" +
            "Dokumentujte nepravilnost/krsenje\n" +
            ...
            "Pozovite policiju\n" +
            "Zatrazite od CIK-a BiH ponovno brojanje glasova\n";
    String m21b="Pogresno evidentiranje rezultata glasanju na BM\n" +
            "Upozorite predsjednika BO \n" +
            "Prijavite nepravilnost i/ili kontaktirajte nadleznog koordinatora za posmatranje izbora\n" +
            "Unesite primjedbu u Zapisnik o radu BO\n" +
            "Dokumentujte nepravilnost/krsenje\n" +
            ...
            "Kontaktirajte Opstinsku/Gradsku izbornu komisiju\n" +
            "Zatrazite od CIK-a BiH ponovno brojanje glasova\n";
    String m22b="Otvaranje vreca sa izbornim materijlaom tokom transporta\n" +
            "Upozorite predsjednika BO \n" +
            "Prijavite nepravilnost i/ili kontaktirajte nadleznog koordinatora za posmatranje izbora\n" +
            "Unesite primjedbu u Zapisnik o radu BO\n" +
            "Dokumentujte nepravilnost/krsenje\n" +
    ...
    String m1=m1a+m1b+texto01+texto02+texto03+texto04+texto05;
    String m2=m2a+m2b+texto06+texto03+texto07;
    String m3=m3a+m3b+texto03+texto04+texto05+texto06+texto07;
    String m4=m4a+m4b+texto02+texto03+texto05+texto07;
    String m5=m5a+m5b+texto02+texto03+texto04+texto06+texto07;
    String m6=m6a+m6b+texto03+texto04+texto05+texto06+texto07;
    String m7=m7a+m7b+texto03+texto04+texto05+texto06+texto07;
    String m8=m8a+m8b+texto03+texto04+texto05+texto06+texto07;
    String m9=m9a+m9b+texto03+texto04+texto05+texto06+texto07+texto09;
    String m10=m10a+m10b+texto03+texto04+texto05+texto06+texto07;
    String m11=m11a+m11b+texto03+texto04+texto05+texto06+texto07;
    String m12=m12a+m12b+texto03+texto04+texto05+texto07;
    String m13=m13a+m13b+texto03+texto04+texto05+texto06+texto07;
    String m14=m14a+m14b+texto03+texto04+texto05+texto06+texto07;
    String m15=m15a+m15b+texto03+texto04+texto05+texto06+texto07;
    String m16=m16a+m16b+texto03+texto04+texto05+texto06+texto07;
    String m17=m17a+m17b+texto03+texto04+texto05+texto06+texto08+texto09;
    String m18=m18a+m18b+texto02+texto03+texto04+texto05+texto06+texto07+texto08+texto09;
    String m19=m19a+m19b+texto02+texto03+texto04+texto05+texto06+texto07+texto08+texto09;
    String m20=m20a+m20b+texto02+texto03+texto04+texto05+texto06+texto07+texto08+texto09;
    String m21=m21a+m21b+texto03+texto04+texto05+texto06+texto07+texto08+texto09;
    String m22=m22a+m22b+texto03+texto04+texto05+texto06+texto07+texto08+texto09;
