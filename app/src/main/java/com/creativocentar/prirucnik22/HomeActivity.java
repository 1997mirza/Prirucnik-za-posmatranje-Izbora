...
import com.creativocentar.prirucnik22.R.raw;

import java.util.ArrayList;

import static com.creativocentar.prirucnik22.R.raw.s11;
...
public class HomeActivity extends AppCompatActivity implements db {
    ...
    LinearLayout linearView1,linearView2,pocetnaMjere,pocetnaStara,linearView21,linearView22,linearView23,linearView24,linearView25,linearView26,linearView27
    ...
    TextView opcija1,opcija2,opcija3,opcija4,opcija5,opcija6,opcija7,opcija8,opcija9;
        TextView opcija1Broj,opcija2Broj,opcija3Broj,opcija4Broj,opcija5Broj,opcija6Broj,opcija7Broj,opcija8Broj,opcija9Broj;

        LinearLayout korak1,korak2,korak3,korak4,korak5,korak6,korak7,korak8,korak9;
    LinearLayout korak11,korak22,korak33,korak44,korak55,korak66,korak77,korak88,korak99,linkView;
    ...
    TextView podnaslov11,podnaslov12,podnaslov13,podnaslov14,podnaslov15,podnaslov16,
            ...
            podnaslov81,podnaslov82,podnaslov83,podnaslov84,podnaslov85,podnaslov86,podnaslov88,
            link1, link2;
    ImageView slika;
    EditText searcher;
    int brisi;
    ...
    SpannableString text1,text2,text17,text31,text33,text34,text35,text36;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text1.setSpan(boldSpan,426,592, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);

        text2= new SpannableString(text2b);
        text2.setSpan(boldSpan,530,732, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);

        text17= new SpannableString(text17b);
        text17.setSpan(boldSpan,675,687, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        ...
        text33.setSpan(boldSpan,714,777, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        text33.setSpan(boldSpan1,992,1058, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);

        text34= new SpannableString(text34b);
        text34.setSpan(boldSpan,0,39, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        text34.setSpan(boldSpan1,904,930, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        text34.setSpan(boldSpan2,1406,1439, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        text34.setSpan(boldSpan3,1858,1870, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);



        text35= new SpannableString(text35b);
        text35.setSpan(foregroundSpan,0,232, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        text35.setSpan(uSpan1,0,51, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        text35.setSpan(uSpan2,233,253, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        text35.setSpan(uSpan3,745,813, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        text35.setSpan(uSpan4,1417,1461, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        ...
        text36.setSpan(boldSpan,1472,1700, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        ...
        pocetnaStara = findViewById(R.id.linearView1Bottom);
        pocetnaMjere = findViewById(R.id.linearView1Top);
        ...
        podnaslov88=findViewById(R.id.podnaslov88);
        link1=findViewById(R.id.link1);
        link2=findViewById(R.id.link2);
        link1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
              Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://podlupom.org/"));
        ...
        link2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://izbori.ba/"));
                startActivity(intent);
            }
        });
        ...
        opcija1Broj=findViewById(R.id.opcija1Broj);
        opcija2Broj=findViewById(R.id.opcija2Broj);
        opcija3Broj=findViewById(R.id.opcija3Broj);
        opcija4Broj=findViewById(R.id.opcija4Broj);
        opcija5Broj=findViewById(R.id.opcija5Broj);
        opcija6Broj=findViewById(R.id.opcija6Broj);
        opcija7Broj=findViewById(R.id.opcija7Broj);
        opcija8Broj=findViewById(R.id.opcija8Broj);
        opcija9Broj=findViewById(R.id.opcija9Broj);
        ...
        pocetnaMjere.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        pocetnaStara.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
       ...
       // naslovG7.setOnClickListener(new View.OnClickListener() {
        ...
        podnaslov88.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                searchList.add("439");
                otvoriPrikaz();
                naslovTeksta.setTextColor(Color.parseColor("#ffffff"));
                naslovTeksta.setText("KORISNI LINKOVI");
                textView.setTextColor(Color.parseColor("#ffffff"));
                textView.setText("");
                slika.setVisibility(View.GONE);
    ...
    private void otvoriPod8() {
        ...
        private void otvoriStaruPocetnu() {
            searchList.add("001");
            close();
            linearView2.setVisibility(View.VISIBLE);
            naslovApp.setVisibility(View.VISIBLE);
        }
        private void otvoriStaruPocetnuB() {
            close();
            linearView2.setVisibility(View.VISIBLE);
            naslovApp.setVisibility(View.VISIBLE);
        }
    ...
    private void trazi() {
        ...
        if (!uzorak.equals("")){
            ...
            if((text17b.toLowerCase().contains(uzorak.toLowerCase()))|| (naslov17.toLowerCase().contains(uzorak.toLowerCase())) ||(text17A.toLowerCase().contains(uzorak.toLowerCase()))){
    ...
    public void otvori1() {
        ...
        opcija1Broj.setText("1 - ");
        opcija1.setText("Zaštitite se");
        korak1text.setText(texto1);
        opcija3Broj.setText("2 - ");
        opcija3.setText("Prijavite nepravilnost nadležnom koordinatoru");
        korak3text.setText(texto3);
        opcija4Broj.setText("3 - ");
        opcija4.setText("Unesite primjedbu u zapisnik o radu B0");
        korak4text.setText(texto4);
        opcija5Broj.setText("4 - ");
        opcija5.setText("Dokumentujte nepravilnost/kršenje");
    ...
    public void otvori2() {
        ...
        opcija1Broj.setText("1 - ");
        opcija1.setText("Upozorite predsjednika BO");
        korak1text.setText(texto6);
        opcija2Broj.setText("2 - ");
        opcija2.setText("Prijavite nepravilnost nadležnom koordinatoru");
        korak2text.setText(texto3);
        opcija3Broj.setText("3 - ");
        opcija3.setText("Kontaktirajte Opštinsku/Gradsku izbornu komisiju");
    ...
    public void otvori3() {
        ...
        korak2text.setText(texto3);
        opcija3Broj.setText("3 - ");
        opcija3.setText("Unesite primjedbu u Zapisnik o radu BO");
    ...
    public void otvori4() {
        ...
        opcija1Broj.setText("1 - ");
        opcija1.setText("Prijavite nepravilnost nadležnom koordinatoru");
        korak1text.setText(texto3);
        opcija3Broj.setText("2 - ");
        opcija3.setText("Dokumentujte nepravilnost/kršenje");
    ...
    public void otvori6() {
        ...
        opcija3.setText("Unesite primjedbu u Zapisnik o radu BO");
        korak3text.setText(texto4);
        opcija4Broj.setText("4 - ");
        opcija4.setText("Dokumentujte nepravilnost/kršenje");
    ...
    public void otvori9() {
        ...
        korak1text.setText(texto6);
        opcija2Broj.setText("2 - ");
        opcija2.setText("Tražite kopiju rezultata glasanja (žutu kopiju)");
        korak2text.setText(texto9);
        opcija3Broj.setText("3 - ");
        opcija3.setText("Prijavite nepravilnost nadležnom koordinatoru");
        korak3text.setText(texto3);
        opcija4Broj.setText("4 - ");
        opcija4.setText("Unesite primjedbu u Zapisnik o radu BO");
        korak4text.setText(texto4);
        opcija6Broj.setText("5 - ");
        opcija6.setText("Dokumentujte nepravilnost/kršenje");
    ...
    public void otvori12() {
        ...
        korak1text.setText(texto3);
        opcija2Broj.setText("2 - ");
        opcija2.setText("Unesite primjedbu u Zapisnik o radu BO");
    ...
    public void otvori13() {
        ...
        korak1text.setText(texto6);
        opcija2Broj.setText("2 - ");
        opcija2.setText("2 - Prijavite nepravilnost nadležnom koordinatoru");
        korak2text.setText(texto3);
        opcija3Broj.setText("3 - ");
        opcija3.setText("Unesite primjedbu u Zapisnik o radu BO");
        korak3text.setText(texto4);
    ...
    public void otvori17() {
        ...
        opcija4.setText("Dokumentujte nepravilnost/kršenje");
        korak4text.setText(texto5);
        opcija5Broj.setText("5 - ");
        opcija5.setText("Tražite kopiju rezultata glasanja (žutu kopiju)");
        korak5text.setText(texto9);
        opcija6Broj.setText("6 - ");
        opcija6.setText("Zatražite od CIK-a BiH ponovno brojanje glasova");
    ...
    public void otvori18() {
        ...
        opcija5.setText("Tražite kopiju rezultata glasanja (žutu kopiju)");
        korak5text.setText(texto9);
        opcija8Broj.setText("6 - ");
        opcija8.setText("Zatražite od CIK-a BiH ponovno brojanje glasova");
    ...
    public void otvori21() {
        ...
        opcija5.setText("Tražite kopiju rezultata glasanja (žutu kopiju)");
        korak5text.setText(texto9);
        opcija7Broj.setText("6 - ");
        opcija7.setText("Zatražite od CIK-a BiH ponovno brojanje glasova");
